...
public class ObjectFolderItemPersistenceTest {
	...
	public void testCreate() throws Exception {
		ObjectFolderItemPK pk = new ObjectFolderItemPK(
	...
	public void testFetchByPrimaryKeysWithMultiplePrimaryKeysWhereNoPrimaryKeysExist()
		...
		ObjectFolderItemPK pk1 = new ObjectFolderItemPK(
			RandomTestUtil.nextLong(), RandomTestUtil.nextLong());

		ObjectFolderItemPK pk2 = new ObjectFolderItemPK(
			RandomTestUtil.nextLong(), RandomTestUtil.nextLong());
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"id.objectFolderId", newObjectFolderItem.getObjectFolderId()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"id.objectDefinitionId", RandomTestUtil.nextLong()));
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"id.objectFolderId", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("id.objectDefinitionId"));
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"id.objectDefinitionId", new Object[] {newObjectDefinitionId}));
