...
@Component(
	...
	property = {
		...
		"mvc.command.name=/object_definitions/get_object_definitions_relations"
	},
	service = MVCResourceCommand.class
)
public class GetObjectDefinitionsRelationsMVCResourceCommand
	...
	protected void doServeResource(
		...
		for (ObjectDefinition objectDefinition :
				_getObjectDefinitions(objectDefinitionId)) {
	...
	private List<ObjectDefinition> _getObjectDefinitions(
		...
		return _objectDefinitionLocalService.getObjectDefinitions(
			objectDefinition.getCompanyId(), true, false,
