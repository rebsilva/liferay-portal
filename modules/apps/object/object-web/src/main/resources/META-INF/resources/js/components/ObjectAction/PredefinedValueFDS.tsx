...
export default function PredefinedValueFDS({selectedObjectFields}: IProps) {
	...
	const getEntityFields = (
		selectedObjectFields: ObjectField[] | undefined
	) => {
		console.log('passei por aqui!');

		const dataSetItems = selectedObjectFields?.map((item) => {
			return {
				inputAsValue: (
					<ClayCheckbox
						checked={false}
				...
				name: item.label[defaultLanguageId], // passar
	...
	useEffect(() => {
		getEntityFields(selectedObjectFields);
