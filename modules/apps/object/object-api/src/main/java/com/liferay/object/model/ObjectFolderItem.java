...
public interface ObjectFolderItem
	...
	public static final Accessor<ObjectFolderItem, Long>
		OBJECT_DEFINITION_ID_ACCESSOR = new Accessor<ObjectFolderItem, Long>() {

			@Override
			public Long get(ObjectFolderItem objectFolderItem) {
				return objectFolderItem.getObjectDefinitionId();
			}
	...
	public static final Accessor<ObjectFolderItem, Long>
		OBJECT_FOLDER_ID_ACCESSOR = new Accessor<ObjectFolderItem, Long>() {

			@Override
			public Long get(ObjectFolderItem objectFolderItem) {
				return objectFolderItem.getObjectFolderId();
			}
