...
public class ObjectFolderItemUtil {
	 ...
	 *
	 * @param objectFolderItemPK the primary key of the current object folder item
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public static ObjectFolderItem[] findByUuid_PrevAndNext(
			ObjectFolderItemPK objectFolderItemPK, String uuid,
			OrderByComparator<ObjectFolderItem> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().findByUuid_PrevAndNext(
			objectFolderItemPK, uuid, orderByComparator);
	}
	...
	public static ObjectFolderItem[] findByUuid_C_PrevAndNext(
			ObjectFolderItemPK objectFolderItemPK, String uuid, long companyId,
			OrderByComparator<ObjectFolderItem> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().findByUuid_C_PrevAndNext(
			objectFolderItemPK, uuid, companyId, orderByComparator);
	}
	...
	public static ObjectFolderItem[] findByObjectDefinitionId_PrevAndNext(
			ObjectFolderItemPK objectFolderItemPK, long objectDefinitionId,
			OrderByComparator<ObjectFolderItem> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().findByObjectDefinitionId_PrevAndNext(
			objectFolderItemPK, objectDefinitionId, orderByComparator);
	}
	...
	public static ObjectFolderItem[] findByObjectFolderId_PrevAndNext(
			ObjectFolderItemPK objectFolderItemPK, long objectFolderId,
			OrderByComparator<ObjectFolderItem> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().findByObjectFolderId_PrevAndNext(
			objectFolderItemPK, objectFolderId, orderByComparator);
	}
	 ...
	 */
	public static ObjectFolderItem create(
		ObjectFolderItemPK objectFolderItemPK) {

		return getPersistence().create(objectFolderItemPK);
	}
	 ...
	 * @throws NoSuchObjectFolderItemException if a object folder item with the primary key could not be found
	 */
	public static ObjectFolderItem remove(ObjectFolderItemPK objectFolderItemPK)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().remove(objectFolderItemPK);
	}
	 ...
	 * @throws NoSuchObjectFolderItemException if a object folder item with the primary key could not be found
	 */
	public static ObjectFolderItem findByPrimaryKey(
			ObjectFolderItemPK objectFolderItemPK)
		throws com.liferay.object.exception.NoSuchObjectFolderItemException {

		return getPersistence().findByPrimaryKey(objectFolderItemPK);
	}
	 ...
	 */
	public static ObjectFolderItem fetchByPrimaryKey(
		ObjectFolderItemPK objectFolderItemPK) {

		return getPersistence().fetchByPrimaryKey(objectFolderItemPK);
	}
