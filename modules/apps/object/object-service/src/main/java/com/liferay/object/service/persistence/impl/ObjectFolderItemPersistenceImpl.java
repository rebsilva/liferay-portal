...
public class ObjectFolderItemPersistenceImpl
	...
	private static final String
		_FINDER_COLUMN_OBJECTDEFINITIONID_OBJECTDEFINITIONID_2 =
			"objectFolderItem.id.objectDefinitionId = ?";
	...
	private static final String _FINDER_COLUMN_OBJECTFOLDERID_OBJECTFOLDERID_2 =
		"objectFolderItem.id.objectFolderId = ?";
	...
	public ObjectFolderItemPersistenceImpl() {
		...
		setModelPKClass(ObjectFolderItemPK.class);
	 ...
	 */
	@Override
	public ObjectFolderItem create(ObjectFolderItemPK objectFolderItemPK) {
		ObjectFolderItem objectFolderItem = new ObjectFolderItemImpl();

		objectFolderItem.setNew(true);
		objectFolderItem.setPrimaryKey(objectFolderItemPK);
	 ...
	 */
	@Override
	public ObjectFolderItem remove(ObjectFolderItemPK objectFolderItemPK)
		throws NoSuchObjectFolderItemException {

		return remove((Serializable)objectFolderItemPK);
	}
	 ...
	 */
	@Override
	public ObjectFolderItem findByPrimaryKey(
			ObjectFolderItemPK objectFolderItemPK)
		throws NoSuchObjectFolderItemException {

		return findByPrimaryKey((Serializable)objectFolderItemPK);
	}
	 ...
	 */
	@Override
	public ObjectFolderItem fetchByPrimaryKey(
		ObjectFolderItemPK objectFolderItemPK) {

		return fetchByPrimaryKey((Serializable)objectFolderItemPK);
	}
