...
public class FriendlyURLSeparatorUtil {
	...
	public static String normalize(
		...
		return StringUtil.quote(
			friendlyURLNormalizer.normalizeWithPeriodsAndSlashes(
				friendlyURLSeparator),
			StringPool.SLASH);
	}

	public static String validate(
		long companyId, FriendlyURLNormalizer friendlyURLNormalizer,
		String friendlyURLResolverKey, String friendlyURLSeparator,
		...
		if (Validator.isNull(friendlyURLSeparator)) {
			return LanguageUtil.get(
				locale, "friendly-url-separator-error-cannot-be-empty");
		}

		friendlyURLSeparator = normalize(
			friendlyURLNormalizer, friendlyURLSeparator);
