...
public class ListTypeDefinitionLocalServiceImpl
	...
	public ListTypeDefinition addListTypeDefinition(
		...
		_addListTypeEntries(
			listTypeDefinition.getListTypeDefinitionId(), listTypeEntries,
			userId);
	...
	public ListTypeDefinition updateListTypeDefinition(
		...
		_addListTypeEntries(listTypeDefinitionId, listTypeEntries, userId);
	...
	private void _addListTypeEntries(
			long listTypeDefinitionId, List<ListTypeEntry> listTypeEntries,
			long userId)
		throws PortalException {
